...
import modular_models_old as modular_models
...
@hydra.main(version_base=None, config_path="", config_name="config_nn")
def main(cfg):
    ...
    wandb_logger = WandbLogger(project="rl_transformer_cube", name=f'{cfg.data.dataset_path.split("/")[-1].rsplit(".", 1)[0]}_{cfg.model.init_bottleneck_by_last}_{cfg.model.n_iters}_{cfg.model.n_embd}', save_dir="wandb_saves")

...
class EvalCallback(Callback):
    def __init__(self, data_dir, eval_data, tokenizer, num_examples=128, batch_size=64, save_path=None, config=None, eval_interval=1000):
        super().__init__()
    ...
    def run_evaluation(self, trainer, pl_module):
        ...
        try:
            ...
            eval_dir = os.path.join(self.results_dir, f"step_{trainer.global_step}")
